# we are just createing security groups here not giveing ingress rules that are attached later based on requirement

# createing sg using modules
...
# allowing connections by adding rules
